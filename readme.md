...
* ***Enable tessellation in clampToGround mode*** - This enables tessellation and specifies whether to allow LinearRings to follow the terrain. This is only applicable when the altitude mode is clampToGround. Very large LinearRings should enable tessellation so that they follow the curvature of the earth without going underground and becoming  invisible.
